...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '800', flex: 1, textAlign: 'center', color: palette.text },
  ...
  cardText: { flex: 1 },
  flagName: { fontSize: 16, fontWeight: '800', color: palette.text },
  flagDescription: { color: palette.muted, marginTop: 4, fontSize: 13.5 },
  muted: { color: palette.muted },
  caption: { color: palette.muted, marginTop: 12, fontSize: 12.5 },
});
