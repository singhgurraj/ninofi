...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: palette.muted, fontSize: 12.5 },
  ...
  bubbleOwn: { backgroundColor: palette.primary, borderTopRightRadius: 6, shadowColor: '#111827', shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
  bubbleOther: { backgroundColor: palette.surface, borderTopLeftRadius: 6, borderWidth: 1, borderColor: palette.border, shadowColor: '#111827', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 4 }, elevation: 1 },
  ...
  metaText: { color: palette.muted, fontSize: 11.5, marginTop: 6 },
  metaOwnText: { color: '#E7E8FF' },
  emptyState: { padding: 20, alignItems: 'center', justifyContent: 'center' },
  emptyTitle: { fontSize: 16, fontWeight: '800', color: palette.text, marginBottom: 6 },
  ...
  editCancel: { color: palette.primary, fontSize: 12, fontWeight: '700' },
});
